...
In applications where performance is a key factor, we have shown that our implementation of QIWS comfortably outperforms a popular `R` implementation of IPF [@barthelemy_cran_2016].
