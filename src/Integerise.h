...
// Given a fractional population in n dimensions, with integral marginal sums, construct a QISI object using the 1d
// marginals Class wrapper around QISI for integerisation. Necessary as base class Microsynthesis only stores refs to
// the marginals for efficiency reasons This class needs to construct persistent marginals that can be safely
// referenced. But NB It only stores a ref of the seed array
