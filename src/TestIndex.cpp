...
void unittest::testIndex() {
  ...
  }
  {
    ...
    CHECK_EQUAL(valuest3[0], 0);
    CHECK_EQUAL(valuest3[1], 100);
    CHECK_EQUAL(valuest3[2], 10);
    CHECK_EQUAL(valuest3[3], 110);
    CHECK_EQUAL(valuest3[4], 20);
    CHECK_EQUAL(valuest3[5], 120);
    CHECK_EQUAL(valuest3[6], 1);
    CHECK_EQUAL(valuest3[7], 101);
    CHECK_EQUAL(valuest3[8], 11);
    CHECK_EQUAL(valuest3[9], 111);
    CHECK_EQUAL(valuest3[10], 21);
    CHECK_EQUAL(valuest3[11], 121);
    CHECK_EQUAL(valuest3[12], 2);
    CHECK_EQUAL(valuest3[13], 102);
    CHECK_EQUAL(valuest3[14], 12);
    CHECK_EQUAL(valuest3[15], 112);
    CHECK_EQUAL(valuest3[16], 22);
    CHECK_EQUAL(valuest3[17], 122);
    CHECK_EQUAL(valuest3[18], 3);
    CHECK_EQUAL(valuest3[19], 103);
    CHECK_EQUAL(valuest3[20], 13);
    CHECK_EQUAL(valuest3[21], 113);
    CHECK_EQUAL(valuest3[22], 23);
    CHECK_EQUAL(valuest3[23], 123);
    CHECK_EQUAL(valuest3[24], 4);
    CHECK_EQUAL(valuest3[25], 104);
    CHECK_EQUAL(valuest3[26], 14);
    CHECK_EQUAL(valuest3[27], 114);
    CHECK_EQUAL(valuest3[28], 24);
    CHECK_EQUAL(valuest3[29], 124);

    NDArray<int64_t> at3({5, 3, 2}, valuest3);
    TransposedIndex index3(at3.sizes());
    CHECK_EQUAL(at3[index3], 0);
    CHECK_EQUAL(at3[++index3], 1);
    CHECK_EQUAL(at3[++index3], 2);
    CHECK_EQUAL(at3[++index3], 3);
    CHECK_EQUAL(at3[++index3], 4);
    CHECK_EQUAL(at3[++index3], 10);
    CHECK_EQUAL(at3[++index3], 11);
    CHECK_EQUAL(at3[++index3], 12);
    CHECK_EQUAL(at3[++index3], 13);
    CHECK_EQUAL(at3[++index3], 14);
    CHECK_EQUAL(at3[++index3], 20);
    CHECK_EQUAL(at3[++index3], 21);
    CHECK_EQUAL(at3[++index3], 22);
    CHECK_EQUAL(at3[++index3], 23);
    CHECK_EQUAL(at3[++index3], 24);
    CHECK_EQUAL(at3[++index3], 100);
    CHECK_EQUAL(at3[++index3], 101);
    CHECK_EQUAL(at3[++index3], 102);
    CHECK_EQUAL(at3[++index3], 103);
    CHECK_EQUAL(at3[++index3], 104);
    CHECK_EQUAL(at3[++index3], 110);
    CHECK_EQUAL(at3[++index3], 111);
    CHECK_EQUAL(at3[++index3], 112);
    CHECK_EQUAL(at3[++index3], 113);
    CHECK_EQUAL(at3[++index3], 114);
    CHECK_EQUAL(at3[++index3], 120);
    CHECK_EQUAL(at3[++index3], 121);
    CHECK_EQUAL(at3[++index3], 122);
    CHECK_EQUAL(at3[++index3], 123);
    CHECK_EQUAL(at3[++index3], 124);
  }
