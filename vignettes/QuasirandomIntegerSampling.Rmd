...
autoNumber: all
vignette: |
  %\VignetteIndexEntry{Quasirandom Integer Sampling for Synthetic Population Generation} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
---
...
For this we comparsed the QIWS algorithm to IPF using a number of two-dimensional test cases.
